...
) : AsyncEpoxyController(enableAsync) {
...
) = MvRxEpoxyController(enableAsyncEpoxyModelBuilding) {
 ...
 */
fun <A : BaseMvRxViewModel<B>, B : MvRxState, C : BaseMvRxViewModel<D>, D : MvRxState> EpoxyBaseFragment.simpleController(
    viewModel1: A,
    viewModel2: C,
...
fun <A : BaseMvRxViewModel<B>, B : MvRxState, C : BaseMvRxViewModel<D>, D : MvRxState, E : BaseMvRxViewModel<F>, F : MvRxState> EpoxyBaseFragment.simpleController(
    viewModel1: A,
    viewModel2: C,
    viewModel3: E,
